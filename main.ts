...
let deth2 = sprites.create(assets.image`dethTXTR`, SpriteKind.mean)
deth2.setPosition(15, 110)
let deth3 = sprites.create(assets.image`dethTXTR`, SpriteKind.mean)
deth3.setPosition(25, 110)
let deth4 = sprites.create(assets.image`dethTXTR`, SpriteKind.mean)
deth4.setPosition(35, 110)
let deth5 = sprites.create(assets.image`dethTXTR`, SpriteKind.mean)
deth5.setPosition(45, 110)
let deth6 = sprites.create(assets.image`dethTXTR`, SpriteKind.mean)
deth6.setPosition(55, 110)
let deth7 = sprites.create(assets.image`dethTXTR`, SpriteKind.mean)
deth7.setPosition(65, 110)
let deth8 = sprites.create(assets.image`dethTXTR`, SpriteKind.mean)
deth8.setPosition(75, 110)
let deth9 = sprites.create(assets.image`dethTXTR`, SpriteKind.mean)
deth9.setPosition(85, 110)
let deth10 = sprites.create(assets.image`dethTXTR`, SpriteKind.mean)
deth10.setPosition(95, 110)
let deth11 = sprites.create(assets.image`dethTXTR`, SpriteKind.mean)
deth11.setPosition(105, 110)
let deth12 = sprites.create(assets.image`dethTXTR`, SpriteKind.mean)
deth12.setPosition(115, 110)
let deth13 = sprites.create(assets.image`dethTXTR`, SpriteKind.mean)
deth13.setPosition(125, 110)
let deth14 = sprites.create(assets.image`dethTXTR`, SpriteKind.Enemy)
deth14.setPosition(135, 110)
let deth15 = sprites.create(assets.image`dethTXTR`, SpriteKind.mean)
deth15.setPosition(145, 110)
let deth16 = sprites.create(assets.image`dethTXTR`, SpriteKind.mean)
